...
export default function LiveCoveragePage() {
  ...
  // Récupérer les mises à jour du suivi en direct avec rafraîchissement automatique
  const {
    data: rawUpdates,
    ...
    enabled: !!coverage?.id,
    refetchInterval: refreshInterval, // Utilise l'intervalle dynamique
  });
              ...
              <div className="space-y-6">
                {updates.map((update, index) => {
                  ...
                  return (
                    ...
                    >
                      <Card className={`overflow-hidden shadow-md hover:shadow-lg ${update.important ? "border-red-500" : ""} bg-white dark:bg-gray-950 update-card`}>
                        <CardContent className="p-0 update-card-content">
                          ...
                          <div className="p-4 md:p-5 prose prose-sm dark:prose-invert max-w-none update-card-content">
