...
const AboutPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-100 to-gray-50 overflow-visible" id="histoire">
            ...
            <div className="md:w-2/5 lg:w-1/3 md:pr-8 lg:pr-16 mb-12 md:mb-0 relative z-10">
              <ScrollAnimation threshold={0.1}>
                <div className="md:sticky md:top-10">
                  ...
                  <div className="mt-16 relative flex justify-center md:justify-start max-w-full lg:max-w-[280px] md:block hidden">
      ...
      <section className="pt-20 pb-40 bg-gradient-to-r from-blue-50 to-white overflow-visible" id="valeurs">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            {/* Cards à gauche */}
