  ...
  return (
    <MainLayout>
      {topicLoading ? (
        ...
        <div className="py-16 mb-6 bg-gradient-to-br from-blue-700 via-blue-600 to-blue-800 relative overflow-hidden w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] -mt-6">
