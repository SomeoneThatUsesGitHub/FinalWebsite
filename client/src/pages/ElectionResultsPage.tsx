  ...
  return (
    <MainLayout>
      <Helmet>
        ...
        <meta property="og:url" content={`https://politiquensemble.com/elections/${countryCode?.toLowerCase()}/resultats/${electionId}`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "url": `https://politiquensemble.com/elections/${countryCode?.toLowerCase()}/resultats/${electionId}`,
            "datePublished": date,
            "publisher": {
              "@type": "Organization",
        ...
        {/* Canonical URL */}
        <link rel="canonical" href={`https://politiquensemble.com/elections/${countryCode?.toLowerCase()}/resultats/${electionId}`} />
      </Helmet>
