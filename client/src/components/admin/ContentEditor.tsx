  ...
  const handleAddInstagram = () => {
    ...
    if (url && editor) {
      ...
      if (match && match[2]) {
        ...
        // Utiliser exactement le code fourni par Instagram avec seulement l'URL modifiée
        const embedCode = `
          <blockquote class="instagram-media" data-instgrm-captioned data-instgrm-permalink="${fullUrl}" data-instgrm-version="14">
            <div></div>
          </blockquote>
